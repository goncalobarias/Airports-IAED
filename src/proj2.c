 ...
 *				Superior Técnico
 * 		Description: Main project file for the 2nd IAED Project - 21/22
 *					(Airport Manager).
 */
 ...
 */
int IsUpperCase(char c) { return (c >= 'A' && c <= 'Z' ? TRUE : FALSE); }

/**
 * Checks if the character c is a digit.
 */
int IsDigit(char c) { return (c >= '0' && c <= '9' ? TRUE : FALSE); }
